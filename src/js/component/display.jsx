	...
	return (
		<div>
			...
			<div class="content">
				...
				<div>
					{weatherDetail.description === ""?(<div><h5>City not found...</h5></div>):(
						showWeather && (
							<div>
											...
											<div>
												<span>
													{(() => {
														...
														else if (weatherDetail.description === "Rain, mist") tag = <div><i class="fa-solid fa-smog icon"></i><p>Rain, mist</p></div>;
